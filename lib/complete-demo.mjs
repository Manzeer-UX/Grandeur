...
export function completeDemo(s,now=new Date()){
 ...
 s.products.forEach((p,j)=>fill(p,{sku:`BONKO-${p.id.toUpperCase()}-320`,size:'320mL',pack:'Single bottle',category:'Fruit drinks',subcategory:'Ready-to-drink',brand:'Bonko',unit:'bottle',carton:40,pallet:50,demoUnitCost:22+j,demoSellingPrice:36+j,reorder:500,status:'Active'}));
